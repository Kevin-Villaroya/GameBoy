...
#include "opcode/load/LoadRegisterToAddressFromImmediate.h"
#include "opcode/load/LoadHlIncrementToRegisterA.h"
#include "opcode/load/LoadHlDecrementToRegisterA.h"
#include "opcode/dec/DecrementDoubleRegister.h"
#include "opcode/ei/EI.h"
#include "opcode/restart/RST.h"
...
Instruction* InstructionFactory::forCode(void* context, const Memory& memory,unsigned short pc){
    ...
    switch(byteInstr){
        ...
        case 0xF0:
            ...
            break;
        case 0x2A:
            instruction = new LoadHlIncrementToRegisterA();
            break;
        case 0x3A:
            instruction = new LoadHlDecrementToRegisterA();
            break;
        case 0x0B:
            instruction = new DecrementDoubleRegister(DoubleRegisterName::BC);
            break;
        case 0x1B:
            instruction = new DecrementDoubleRegister(DoubleRegisterName::DE);
            break;
        case 0x2B:
            instruction = new DecrementDoubleRegister(DoubleRegisterName::HL);
            break;
        case 0x3B:
        ...
        case 0xC7:
            ...
            break;
        case 0xCF:
            instruction = new RST(0x08);
            break;
        case 0xD7:
            instruction = new RST(0x10);
            break;
        case 0xDF:
            instruction = new RST(0x18);
            break;
        case 0xE7:
            instruction = new RST(0x20);
            break;
        case 0xEF:
            instruction = new RST(0x28);
            break;
        case 0xF7:
            instruction = new RST(0x30);
            break;
        case 0xFF:
            instruction = new RST(0x38);
            break;
        case 0xE9:
...
Instruction* InstructionFactory::forCodeCb(unsigned char byteInstr){
	...
	switch(byteInstr){
        ...
        case 0x80:
            ...
            break;
        case 0x81:
            instruction = new ResImmediateOfRegister(0, RegisterName::C);
            break;
        case 0x82:
            instruction = new ResImmediateOfRegister(0, RegisterName::D);
            break;
        case 0x83:
            instruction = new ResImmediateOfRegister(0, RegisterName::E);
            break;
        case 0x84:
            instruction = new ResImmediateOfRegister(0, RegisterName::H);
            break;
        case 0x85:
            instruction = new ResImmediateOfRegister(0, RegisterName::L);
            break;
        case 0x86:
            instruction = new ResImmediateOfHL(0);
            break;
        case 0x87:
            instruction = new ResImmediateOfRegister(0, RegisterName::A);
            break;
        case 0x88:
            instruction = new ResImmediateOfRegister(1, RegisterName::B);
            break;
        case 0x89:
            instruction = new ResImmediateOfRegister(1, RegisterName::C);
            break;
        case 0x8A:
            instruction = new ResImmediateOfRegister(1, RegisterName::D);
            break;
        case 0x8B:
            instruction = new ResImmediateOfRegister(1, RegisterName::E);
            break;
        case 0x8C:
            instruction = new ResImmediateOfRegister(1, RegisterName::H);
            break;
        case 0x8D:
            instruction = new ResImmediateOfRegister(1, RegisterName::L);
            break;
        case 0x8E:
            instruction = new ResImmediateOfHL(1);
            break;
        case 0x8F:
            instruction = new ResImmediateOfRegister(1, RegisterName::A);
            break;
        case 0x90:
            instruction = new ResImmediateOfRegister(2, RegisterName::B);
            break;
        case 0x91:
            instruction = new ResImmediateOfRegister(2, RegisterName::C);
            break;
        case 0x92:
            instruction = new ResImmediateOfRegister(2, RegisterName::D);
            break;
        case 0x93:
            instruction = new ResImmediateOfRegister(2, RegisterName::E);
            break;
        case 0x94:
            instruction = new ResImmediateOfRegister(2, RegisterName::H);
            break;
        case 0x95:
            instruction = new ResImmediateOfRegister(2, RegisterName::L);
            break;
        case 0x96:
            instruction = new ResImmediateOfHL(2);
            break;
        case 0x97:
            instruction = new ResImmediateOfRegister(2, RegisterName::A);
            break;
        case 0x98:
            instruction = new ResImmediateOfRegister(3, RegisterName::B);
            break;
        case 0x99:
            instruction = new ResImmediateOfRegister(3, RegisterName::C);
            break;
        case 0x9A:
            instruction = new ResImmediateOfRegister(3, RegisterName::D);
            break;
        case 0x9B:
            instruction = new ResImmediateOfRegister(3, RegisterName::E);
            break;
        case 0x9C:
            instruction = new ResImmediateOfRegister(3, RegisterName::H);
            break;
        case 0x9D:
            instruction = new ResImmediateOfRegister(3, RegisterName::L);
            break;
        case 0x9E:
            instruction = new ResImmediateOfHL(3);
            break;
        case 0x9F:
            instruction = new ResImmediateOfRegister(3, RegisterName::A);
            break;
        case 0xA0:
            instruction = new ResImmediateOfRegister(4, RegisterName::B);
            break;
        case 0xA1:
            instruction = new ResImmediateOfRegister(4, RegisterName::C);
            break;
        case 0xA2:
            instruction = new ResImmediateOfRegister(4, RegisterName::D);
            break;
        case 0xA3:
            instruction = new ResImmediateOfRegister(4, RegisterName::E);
            break;
        case 0xA4:
            instruction = new ResImmediateOfRegister(4, RegisterName::H);
            break;
        case 0xA5:
            instruction = new ResImmediateOfRegister(4, RegisterName::L);
            break;
        case 0xA6:
            instruction = new ResImmediateOfHL(4);
            break;
        case 0xA7:
            instruction = new ResImmediateOfRegister(4, RegisterName::A);
            break;
        case 0xA8:
            instruction = new ResImmediateOfRegister(5, RegisterName::B);
            break;
        case 0xA9:
            instruction = new ResImmediateOfRegister(5, RegisterName::C);
            break;
        case 0xAA:
            instruction = new ResImmediateOfRegister(5, RegisterName::D);
            break;
        case 0xAB:
            instruction = new ResImmediateOfRegister(5, RegisterName::E);
            break;
        case 0xAC:
            instruction = new ResImmediateOfRegister(5, RegisterName::H);
            break;
        case 0xAD:
            instruction = new ResImmediateOfRegister(5, RegisterName::L);
            break;
        case 0xAE:
            instruction = new ResImmediateOfHL(5);
            break;
        case 0xAF:
            instruction = new ResImmediateOfRegister(5, RegisterName::A);
            break;
        case 0xB0:
            instruction = new ResImmediateOfRegister(6, RegisterName::B);
            break;
        case 0xB1:
            instruction = new ResImmediateOfRegister(6, RegisterName::C);
            break;
        case 0xB2:
            instruction = new ResImmediateOfRegister(6, RegisterName::D);
            break;
        case 0xB3:
            instruction = new ResImmediateOfRegister(6, RegisterName::E);
            break;
        case 0xB4:
            instruction = new ResImmediateOfRegister(6, RegisterName::H);
            break;
        case 0xB5:
            instruction = new ResImmediateOfRegister(6, RegisterName::L);
            break;
        case 0xB6:
            instruction = new ResImmediateOfHL(6);
            break;
        case 0xB7:
            instruction = new ResImmediateOfRegister(6, RegisterName::A);
            break;
        case 0xB8:
            instruction = new ResImmediateOfRegister(7, RegisterName::B);
            break;
        case 0xB9:
            instruction = new ResImmediateOfRegister(7, RegisterName::C);
            break;
        case 0xBA:
            instruction = new ResImmediateOfRegister(7, RegisterName::D);
            break;
        case 0xBB:
            instruction = new ResImmediateOfRegister(7, RegisterName::E);
            break;
        case 0xBC:
            instruction = new ResImmediateOfRegister(7, RegisterName::H);
            break;
        case 0xBD:
            instruction = new ResImmediateOfRegister(7, RegisterName::L);
            break;
        case 0xBE:
            instruction = new ResImmediateOfHL(7);
            break;
        case 0xBF:
